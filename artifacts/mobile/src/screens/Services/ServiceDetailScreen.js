...
import {
  callServiceNow, messageProvider, callPhone, formatServicePhones, navigateToBooking, callProviderNow,
        ...
        {provider && (
          ...
          >
            ...
            <TouchableOpacity
              ...
              onPress={(e) => {
                e?.stopPropagation?.();
                messageProvider(provider?.phone || '', 'Hello, I would like more information about your service.');
              }}
            >
...
const createStyles = (COLORS, SHADOWS) => StyleSheet.create({
  ...
  discountBadge: {
    ...
    backgroundColor: COLORS.card, borderRadius: 12, padding: 10, alignItems: 'center',
  ...
  ratingPill: {
    ...
    backgroundColor: COLORS.surfaceAlt, borderRadius: 20, paddingHorizontal: 10, paddingVertical: 4,
    marginLeft: 'auto',
  ...
  featureCheck: {
    width: 20, height: 20, borderRadius: 10, backgroundColor: 'rgba(255,255,255,0.18)',
